...
';
	...
	<tr>
		...
		<div><span style="vertical-align: middle;">' . $theme['name'] . ($theme['dirname'] == $site->theme() ? '</span><span class="badge badge-primary ml-2">' . $L->g('Active') . '</span>' : '') . '</div>
			<div class="mt-1">
	';
	...
	';
		...
		echo '<td class="align-middle d-none d-sm-table-cell w-50">';
